...
const Chat: React.FC = () => {
  ...
  const [siderBarList, setSiderBarList] = useState<{ icon: ReactElement<any, any>; name: string; isActivity: boolean; }[]>([
    {
      ...
      <div className={styles.sidebar}>
        {
          siderBarList.map((item) => (
            <div key={item.name} onClick={() => selectedComponent(item.name)}
